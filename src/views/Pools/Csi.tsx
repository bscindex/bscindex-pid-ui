...
const Farm: React.FC = () => {
  ...
  const poolsWithApy = pools.map((pool) => {
    ...
    const totalRewardPricePerYear = rewardTokenPriceInBNB.times(CID_PER_BLOCK).times(pool.tokenPerBlock).times(BLOCKS_PER_YEAR)
    ...
    <Page>
      <Hero>
        <div>
          ...
          <Heading as="h4" size="xl" mb="14px">
            {TranslateString(282, 'CAUTION!!! PLEASE DO NOT SELL / MOVE YOUR EARNED #CSI TOKEN. YOUR TRANSACTION MAY REVERT THEN.')}
          </Heading>
          <ul>
