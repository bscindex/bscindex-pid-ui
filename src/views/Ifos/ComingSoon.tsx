...
import { Button, Text } from '@bscindexpid/uikit'
  ...
  return (
    <Page>
      ...
      <Content>
        <div>
          <Block>
            <Title as="h2">{TranslateString(999, 'Coming Soon to PkidFinance.')}</Title>
            <Text mb={3}>
              {TranslateString(
                504,
                'You’ll pay for the new tokens using PKID-BNB LP tokens, which means you need to stake equal amounts of PKID and BNB in a liquidity pool to take part.',
              )}
            </Text>
            <Text mb={3}>
              <LiquidityLink href="https://cheeseswap.app/#/add/ETH/0x2cc26dd730F548dc4ac291ae7D84a0C96980d2cB">
                {TranslateString(506, 'Get PKID-BNB LP >')}
              </LiquidityLink>
            </Text>
            <Text mb={3}>
              {TranslateString(508, 'The project gets the BNB, PkidFinance burns the PKID.')}
              <br />
