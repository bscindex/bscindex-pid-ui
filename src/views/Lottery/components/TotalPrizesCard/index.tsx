...
import { Heading, Card, CardBody, CardFooter, Text, BSCIndexRoundIcon, Flex, Skeleton } from '@bscindexpid/uikit'
        ...
        <CardHeading>
          <Left>
            ...
            <PrizeCountWrapper>
              ...
              <Heading size="lg">{lotteryPrizeWithCommaSeparators} PKID</Heading>
            </PrizeCountWrapper>
          </Left>
          <Right>
