...
import { Heading, CardBody, CardFooter, BSCIndexRoundIcon, TicketRound } from '@bscindexpid/uikit'
      ...
      <>
        <CardBody>
          <CardHeading>
            ...
            <LotteryCardHeading
              valueToDisplay={TranslateString(999, `${poolSize.toLocaleString()} PKID`)}
